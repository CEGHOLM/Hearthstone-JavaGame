 ...
 * specific information about what exactly did change state
 * in the game.
 *
 ...
 *
 * Direct mutator events follow the naming pattern:
 * on(Verb)(Subject); while indirect/side effect mutator
 * events follow the pattern on(Subject)(Verb).
 * Example: onPlayCard (direct mutation) and onCardDraw (indirect).
 *
 ...
 * then NO notification 'onPlayCard' should be sent (the
...
public interface GameObserver {
     ...
     * @param atIndex the index the card was played at
     */
